...
4. Но, если мы оставим всё как есть, то Git не будет знать что с этим делать, как это исправить? _Ответ: через создание папки **(.gitignore)** и добавляем название того файла, который Git должен игнорить._
